      ...
      <header className="app-header">
        <div className="header-inner">
          ...
          <div className="header-socials">
            ...
            <a href="https://instagram.com/cowboysurferstyle" target="_blank" rel="noopener noreferrer" className="header-social-link" title="Instagram">
              <svg width="17" height="17" viewBox="0 0 24 24" fill="currentColor">
            ...
            <a href="https://tiktok.com/@cowboysurferstyle" target="_blank" rel="noopener noreferrer" className="header-social-link" title="TikTok">
              <svg width="17" height="17" viewBox="0 0 24 24" fill="currentColor">
